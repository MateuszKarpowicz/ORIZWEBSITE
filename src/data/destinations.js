export const destinations = [
  {
    ...
    description: `Z jednej strony tygiel kulturowy zamieszkały przez reprezentantów 
      ...
      Korzystamy z komunikacji miejskiej, jemy w restauracjach, wklejamy się 
      na te parę dni w żywą tkankę miejską Londynu. Całościowo daje to efekt 
      pełnego doświadczenia, poczucie poznania miasta nie tylko od strony 
  ...
  },
  {
    ...
    description: `Malta to wyjątkowy kierunek na wycieczkę szkolną, który łączy fascynującą 
      ...
      średniowieczną Mdinę – Malta to prawdziwy skarbiec historii i architektury.

      W programie wycieczki znajdują się najważniejsze atrakcje wyspy, takie jak 
      urokliwe wioski rybackie, Błękitna Laguna czy spektakularne klify Dingli. 
      Podczas zwiedzania młodzież ma okazję poznać różnorodne wpływy kulturowe, 
      od fenickich po brytyjskie, które ukształtowały unikalny charakter Malty.

      Dzięki wygodnemu transportowi busami i dobrze zaplanowanemu programowi, 
  ...
  },
  {
    ...
    description: `Barcelona to idealny kierunek na wycieczkę szkolną, który łączy edukację 
      ...
      okazję zobaczyć na własne oczy, jak historia, sztuka i nowoczesność przenikają 
      się w tym wyjątkowym mieście.

      W programie wycieczki nie może zabraknąć spaceru słynną Las Ramblas, wizyty 
      na stadionie Camp Nou czy podziwiania panoramy miasta z wzgórza Montjuïc. 
      Dodatkowo, dzięki zakwaterowaniu na słonecznym wybrzeżu Costa Brava, wycieczka 
      pozwala połączyć zwiedzanie z chwilą relaksu nad Morzem Śródziemnym.

      Nasza oferta jest dostosowana do potrzeb grup szkolnych – zapewniamy wygodny 
  ...
  },
  {
    ...
    description: `Stany Zjednoczone to kraj nieograniczonych możliwości, gdzie każdy stan 
      ...
      Nasze wycieczki do USA są starannie zaplanowane, aby pokazać różnorodność 
      i bogactwo tego fascynującego kraju. Łączymy zwiedzanie ikonicznych miejsc 
      z poznawaniem lokalnej kultury i stylu życia.

      Program dostosowujemy do potrzeb i zainteresowań grup szkolnych, zapewniając 
      profesjonalną opiekę i wsparcie na każdym etapie podróży.`,
  },
  {
    id: "azja",
    title: "AZJA",
    ...
    description: `Azja to fascynujący kontynent kontrastów, gdzie nowoczesne metropolie 
      ...
      Nasze wycieczki do Azji to starannie zaplanowane podróże, podczas których 
      młodzież może poznać różnorodność tego kontynentu. Od japońskiej technologii 
      po tajską gościnność, od chińskich zabytków po koreańską popkulturę.
...
Neapol to nie tylko nauka, ale także inspiracja i wyjątkowa okazja do doświadczenia różnorodności Włoch – wyjazd, który uczniowie zapamiętają na zawsze.`,
  ...
  },
  {
    ...
    description: `Teneryfa, największa z Wysp Kanaryjskich, to wyjątkowe miejsce na wycieczkę 
      ...
      szczyt Hiszpanii oraz niezwykłe formacje skalne powstałe z lawy.

      Wyspa zachwyca także różnorodnością – od urokliwych miasteczek, takich jak 
      La Laguna, po rajskie plaże idealne na chwilę relaksu. Wizyta w Loro Parku, 
      jednym z najpiękniejszych ogrodów zoologicznych na świecie, to edukacyjna 
      przygoda, która z pewnością spodoba się młodzieży.
  ...
  },
  {
    ...
    description: `Edynburg, nazywany "Atenami Północy", to idealne miejsce na wycieczkę 
      ...
      miasta z Arthurs Seat.

      W programie wycieczki nie może zabraknąć wizyty w Holyrood Palace – 
      oficjalnej rezydencji brytyjskiej rodziny królewskiej w Szkocji – oraz 
      odkrywania uroków dzielnicy New Town, pełnej georgiańskiej architektury. 
      Spacerując po klimatycznych uliczkach, uczniowie mogą poczuć atmosferę 
      miasta, które było inspiracją dla literatury, od Szekspira po J.K. Rowling.
  ...
  },
  {
    ...
    description: `Dublin, serce Irlandii, to miejsce, które idealnie łączy historię z 
      ...
      Program wycieczki obejmuje wizytę w Trinity College, gdzie uczniowie mogą 
      zobaczyć słynny "Book of Kells", oraz zwiedzanie Zamku Dublińskiego i 
      Katedry św. Patryka. Spacer po klimatycznym Temple Bar oraz wizyta w 
      muzeum EPIC pozwalają poznać irlandzką kulturę i historię emigracji.

      Młodzież może również odwiedzić Phoenix Park, jeden z największych parków 
      miejskich w Europie, idealny na chwilę relaksu. Dublin to miasto, które 
      inspiruje swoją kulturą i dziedzictwem, sprawiając, że każda wycieczka 
      staje się niezapomnianą przygodą edukacyjną.`,
  },
  {
    id: "lizbona",
    title: "LIZBONA",
    ...
    description: `Lizbona to niezwykła stolica Portugalii, idealna na wycieczkę szkolną, 
      ...
      W programie wycieczki nie może zabraknąć wizyty przy słynnej Wieży Belem, 
      Klasztorze Hieronimitów oraz na Placu Comercio, będącym sercem miasta. 
      Spacerując po dzielnicy Baixa, uczniowie mogą poczuć atmosferę odnowionego 
      centrum miasta, pełnego kawiarni i sklepów.

      Niezapomnianym doświadczeniem jest przejażdżka zabytkowym tramwajem 28, 
      który prowadzi przez najbardziej malownicze zakątki Lizbony, w tym wzgórza 
  ...
  },
  {
    ...
    description: `Kraków to jedno z najpiękniejszych miast Polski, które oferuje niezliczone 
      ...
      W programie wycieczki znajduje się Wawel, gdzie uczniowie mogą zobaczyć 
      Zamek Królewski i Katedrę, będące symbolem polskiej historii. Spacer po 
      Rynku Głównym, największym średniowiecznym placu w Europie, prowadzi do 
      takich zabytków jak Kościół Mariacki, Sukiennice czy Wieża Ratuszowa.

      Odkrywanie uroków Kazimierza, dawnej dzielnicy żydowskiej, ukazuje 
      wielokulturową przeszłość Krakowa i jego unikalny charakter. Kraków to 
      również niezapomniana okazja do poznania codziennego życia w mieście 
      pełnym zabytków, zielonych parków i klimatycznych uliczek.`,
  },
  {
    id: "obozy-sportowe",
    ...
    description: `Nasze obozy sportowe to idealne połączenie aktywnego wypoczynku, 
      ...
      Program obozów jest dostosowany do różnych poziomów zaawansowania i 
      obejmuje zarówno zajęcia sportowe, jak i rekreacyjne. Zapewniamy 
      profesjonalną infrastrukturę sportową i sprzęt najwyższej jakości.

      Oprócz treningów, uczestnicy mają czas na integrację, odpoczynek i 
      dodatkowe atrakcje. To doskonała okazja do rozwoju pasji sportowych 
      i nawiązania nowych przyjaźni w aktywnej atmosferze.`,
  },
  {
    id: "obozy-jezykowe",
    ...
    description: `Obozy językowe to innowacyjne podejście do nauki języków obcych, gdzie 
      ...
      Program obejmuje nie tylko tradycyjne lekcje, ale także konwersacje, 
      projekty kulturowe i zajęcia tematyczne. Uczestnicy mają okazję używać 
      języka w praktycznych sytuacjach, co znacząco przyspiesza proces nauki.

      Dodatkowo organizujemy wydarzenia integracyjne i wycieczki, podczas których 
      młodzież może praktykować zdobyte umiejętności językowe w naturalnym 
      środowisku. To skuteczny sposób na przełamanie bariery językowej i 
      rozwinięcie pewności siebie w komunikacji.`,
  },
  {
    ...
    description: `Masz pomysł na wyjątkową wycieczkę szkolną? Chcesz zorganizować wyjazd 
      ...
      Nasz zespół doświadczonych specjalistów pomoże przekształcić Twoje pomysły 
      w profesjonalnie zorganizowaną wycieczkę. Zajmiemy się wszystkimi aspektami 
      organizacji - od transportu i zakwaterowania po program zwiedzania i atrakcje 
      dodatkowe.

      Skontaktuj się z nami i opowiedz o swoim wymarzonym wyjeździe. Wspólnie 
      stworzymy plan idealnej wycieczki, która spełni oczekiwania wszystkich 
      uczestników i pozostawi niezapomniane wspomnienia.`,
  },
];
